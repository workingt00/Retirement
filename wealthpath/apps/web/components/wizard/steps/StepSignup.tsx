...
export default function StepSignup() {
  ...
  const isValidRegister = email.includes("@") && password.length >= 8;
  const isValidLogin = email.includes("@") && password.length >= 1;
  const isValid = mode === "register" ? isValidRegister : isValidLogin;
